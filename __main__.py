...
if __name__ == '__main__':
    try:
        ...
        matching_mods(MODS[1], 3, 25, 1500000000)
        matching_mods(MODS[1], 3, 26, 3000000000)
        surface_data(MODS[1], 3, targets=[[3900, "_DPS_24_PRICE_1000000000"], [3950, "_DPS_25_PRICE_1500000000"], [4000, "_DPS_26_PRICE_3000000000"]])
      
        matching_mods(MODS[2], 4, 25, 1000000000)
        matching_mods(MODS[2], 4, 26, 2000000000)
        matching_mods(MODS[2], 4, 27, 3000000000)
        surface_data(MODS[2], 4, targets=[[3350, "_DPS_25_PRICE_1000000000"], [3400, "_DPS_26_PRICE_2000000000"], [3450, "_DPS_27_PRICE_3000000000"]])
